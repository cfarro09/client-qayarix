            ...
            if (startdate) {
                ...
                await triggeraxios('post', '/api/web/main/', datarequest("SP_DASHBOARD_CLIENTE")).then(r => {
                    ...
                    setgraphclients([
                        ...
                        { name: "Recolectado", GUIA: ccaux.total_guias_entregadas, BULTO: ccaux.total_bultos_entregados },
                        { name: "R. Parcial", GUIA: ccaux.total_guias_parcial, BULTO: ccaux.total_bultos_parcial },
                        { name: "No recolectado", GUIA: ccaux.total_guias_noEntregados, BULTO: ccaux.total_bultos_noEntregados },
